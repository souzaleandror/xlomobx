...
void main() async {
  ...
  final category = ParseObject('Categories')..set<String>('Title', "camisetas")..set<int>('Position', 2);
  final response = await category.save();
  print(response.success);


  final category2 = ParseObject('Categories')..set<String>('Title', "Meias")..set<int>('Position', 1);
  final response2 = await category.save();
  print(response2.success);

  final category3 = ParseObject('Categories')..objectId = 'k1NfQDGEl9'..set<int>('Position', 3);
